...
var StreamBinding = class extends WorkerEntrypoint {
  ...
  async generate(fileOrUrl, params) {
    ...
    if (typeof fileOrUrl == "string") {
      let row2 = await stub.createWatermarkFromUrl(fileOrUrl, params);
      return rowToStreamWatermark(row2);
    }
    let buffer = await new Response(fileOrUrl).arrayBuffer(), row = await stub.createWatermarkFromBody(buffer, null, params);
